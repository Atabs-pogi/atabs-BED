...
public interface AccountDao extends JpaRepository<AccountEntity,Long> {
    ...
    @Query(value = "SELECT * FROM Accounts WHERE binary username =:username AND binary password =:secret",nativeQuery = true)
    AccountEntity getUserLogin(String username, String secret);
